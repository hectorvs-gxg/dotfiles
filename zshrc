...
export ycmd_path=/Users/hvs/Code/ycmd/
export python_path=/usr/bin/

# Docker ENV
export DOCKER_HOST=tcp://192.168.59.103:2376
export DOCKER_CERT_PATH=/Users/hvs/.boot2docker/certs/boot2docker-vm
...
#
alias rdb="rake db:drop db:create db:migrate db:fixtures:load"
